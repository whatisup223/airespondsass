        ...
        <aside class="w-72 glass-sidebar flex-shrink-0 relative z-20 flex flex-col transition-all duration-300"
            ...
            <nav class="flex-grow px-4 space-y-2 overflow-y-auto">
                ...
                <a href="/admin/dashboard"
                    class="flex items-center gap-4 px-4 py-3 rounded-xl transition-all hover:bg-white/5 {{ request()->is('admin/dashboard') ? 'active-link-admin' : 'text-gray-400 hover:text-white' }}">
                    <svg class="w-5 h-5 {{ request()->is('admin/dashboard') ? 'text-rose-500' : '' }}" fill="none"
                ...
                <a href="/admin/users"
                    class="flex items-center gap-4 px-4 py-3 rounded-xl transition-all hover:bg-white/5 {{ request()->is('admin/users') ? 'active-link-admin' : 'text-gray-400 hover:text-white' }} group">
                    <svg class="w-5 h-5 {{ request()->is('admin/users') ? 'text-rose-500' : 'group-hover:text-rose-500' }}"
                ...
                <a href="/admin/plans"
                    class="flex items-center gap-4 px-4 py-3 rounded-xl transition-all hover:bg-white/5 {{ request()->is('admin/plans') ? 'active-link-admin' : 'text-gray-400 hover:text-white' }} group">
                    <svg class="w-5 h-5 {{ request()->is('admin/plans') ? 'text-rose-500' : 'group-hover:text-rose-500' }}"
                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="/admin/ai-providers"
                    class="flex items-center gap-4 px-4 py-3 rounded-xl transition-all hover:bg-white/5 {{ request()->is('admin/ai-providers') ? 'active-link-admin' : 'text-gray-400 hover:text-white' }} group">
                    <svg class="w-5 h-5 {{ request()->is('admin/ai-providers') ? 'text-rose-500' : 'group-hover:text-rose-500' }}"
                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="/admin/settings"
                    class="flex items-center gap-4 px-4 py-3 rounded-xl transition-all hover:bg-white/5 {{ request()->is('admin/settings') ? 'active-link-admin' : 'text-gray-400 hover:text-white' }} group">
                    <svg class="w-5 h-5 {{ request()->is('admin/settings') ? 'text-rose-500' : 'group-hover:text-rose-500' }}"
                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
